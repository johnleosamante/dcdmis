<div class="modal-dialog">
  <div class="modal-content">
    <div class="modal-header">
      <h5 class="modal-title">Update Learning &amp; Development Intervention</h5>
    ...
    <form method="post" role="form" action="">
      ...
      if (mysqli_num_rows($trainings) > 0) {
        ...
        $title = $from = $to = $hours = $type = $sponsor = '';
      }
      ?>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="UpdateTraining">Save</button>
      </div><!-- .modal-footer -->
    </form>
  </div><!-- .modal-content -->
</div><!-- .modal-dialog -->