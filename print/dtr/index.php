...
$PNG_WEB_DIR = '../../temp/dtr/';
include_once("../../_includes_/PHPQRCode/qrlib.php");

$img1 = '../../assets/img/logo.png';
$img2 = '../../assets/img/department.png';
...
$pdf->Cell(75, 3, 'DIVISION OF DIPOLOG CITY', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'DIVISION OF DIPOLOG CITY', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'DIVISION OF DIPOLOG CITY', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'DIVISION OF DIPOLOG CITY', 0, 1, 'C');

$pdf->SetFont('Arial', '', 6);
$pdf->Cell(75, 3, 'Dipolog City', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'Dipolog City', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'Dipolog City', 0, 0, 'C');
$pdf->Cell(15, 3, '', 0, 0, 'C');
$pdf->Cell(75, 3, 'Dipolog City', 0, 1, 'C');
...
if (mysqli_num_rows($myinfoDTR) == 0) {
	...
	while ($mydate <= 31) {
		...
		if ($days == 'Saturday') {
			$pdf->Cell(10, 3.5, $mydate . ' (' . $myday . ')', 1, 0, 'C');
	...
	while ($row = mysqli_fetch_array($myinfoDTR)) {
		...
		while ($myyear > $no) {
			...
			if ($no < 10) {
				//First Form
				if ($days == 'Saturday') {
					$pdf->Cell(10, 3.5, $no . ' (' . $myday . ')', 1, 0, 'C');
					$pdf->Cell(44, 3.5, 'SATURDAY', 1, 0, 'C');
					$pdf->Cell(11, 3.5, '', 1, 0, 'C');
					$pdf->Cell(11, 3.5, '', 1, 0, 'C');
				} elseif ($days == 'Sunday') {
		...
		$pdf->Cell(10, 3.5, $myyear . ' (' . $myday . ')', 1, 0, 'C');
	...
	while ($myyear < $gdate) {
		...
		if ($myyear < 10) {
			//First Form
			if ($days == 'Saturday') {
				$pdf->Cell(10, 3.5, '0' . $myyear . ' (' . $myday . ')', 1, 0, 'C');
				$pdf->Cell(44, 3.5, 'SATURDAY', 1, 0, 'C');
				$pdf->Cell(11, 3.5, '', 1, 0, 'C');
				$pdf->Cell(11, 3.5, '', 1, 0, 'C');
			} elseif ($days == 'Sunday') {
