...
$pdf->Line(44, 72.5, 175, 72.5);
$pdf->Ln(4);
$pdf->Cell(30, 0, 'Position');
$pdf->Cell(3, 0, ':');
$pdf->Cell(0, 0, '');
$pdf->Line(44, 76.5, 175, 76.5);
$pdf->Ln(4);
$pdf->Cell(30, 0, 'Inclusive Dates');
$pdf->Cell(3, 0, ':');
$pdf->Cell(0, 0, $trainingDate);
$pdf->Line(44, 80.5, 175, 80.5);
$pdf->Ln(4);
$pdf->Cell(30, 0, 'Purpose/s');
$pdf->Cell(3, 0, ':');
$pdf->Cell(0, 0, $trainingTitle);
$pdf->Line(44, 84.5, 175, 84.5);
$pdf->Ln(6);
$pdf->Line(102, 93, 175, 93);
...
$pdf->Image(root() . '/uploads/signature/' . $signatory . '/' . $signatory . '.png', ($width / 2) - ($signatureWidth / 2), $currentOrdinate + 3, $signatureWidth);
$pdf->Ln(18);
