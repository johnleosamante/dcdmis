<div class="row">
                ...
                <!-- /.col-lg-12 -->
				 ...
				 if (isset($_POST['update_library']))
				 {
					 ...
					 mysqli_query($con,"UPDATE wp_computer_lab SET location_details='".$mynewimage."' WHERE SchoolID='".$_SESSION['school_id']."' AND No='".$_SESSION['PicNo']."' LIMIT 1");
				 ...
				 }else if (isset($_POST['Add_library']))
				 {
					 ...
					 move_uploaded_file($temp, $mynewimage);
					 mysqli_query($con,"INSERT INTO wp_computer_lab VALUES(NULL,'".$mynewimage."','".$_SESSION['school_id']."')");  
				 ...
				 ?>
					...
					<form action="" Method="POST" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
							 ...
							 <?php
								$mymessage=mysqli_query($con,"SELECT * FROM wp_computer_lab WHERE SchoolID='".$_SESSION['school_id']."'");
