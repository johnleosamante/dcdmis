	...
	<div class="row">
                ...
                <!-- /.col-lg-12 -->
				 ...
				 if (isset($_POST['SSG_chart']))
				 {
					 ...
					 $mynewimage='../../images/ssg-'.$_SESSION['school_id'].'.'.$ext;
						
					 move_uploaded_file($temp, $mynewimage);
					$result=mysqli_query($con,"SELECT * FROM wp_ssg_chart WHERE SchoolID='".$_SESSION['school_id']."'");	
					  if (mysqli_num_rows($result)==0)
					  {
						mysqli_query($con,"INSERT INTO wp_ssg_chart VALUES(NULL,'".$mynewimage."','".$_SESSION['school_id']."')");  
					  }else{
					   mysqli_query($con,"UPDATE wp_ssg_chart SET location_details='".$mynewimage."' WHERE SchoolID='".$_SESSION['school_id']."' LIMIT 1");
					  }
					if (mysqli_affected_rows($con)==1)
					 {
						 $Err = "SSG Organizational chart Successfully Saved";
					...
					<form action="" Method="POST" enctype="multipart/form-data">
						 ...
						 <?php
						  echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("website")).'" style="float:right;" class="btn btn-secondary">Back</a>';
						    ...
						    <h4>STUDENT SUPREME GOVERNMENT ORGANIZATION CHART</h4>
						   </div>
                        ...
                        <div class="panel-body">
							 ...
							 <?php
								$mymessage=mysqli_query($con,"SELECT * FROM wp_ssg_chart WHERE SchoolID='".$_SESSION['school_id']."' LIMIT 1");
...
<div class="panel-body">
	 ...
	 <div class="modal-dialog">
      ...
      <div class="modal-content">
			...
			<input type="submit" name="SSG_chart" value="Save" style="cursor:pointer;" class="btn btn-primary">
			</div>
			</form>	
