...
include_once("../../../pcdmis/vendor/jquery/function.php");
		...
		$ENRO="ELIGIBILITY FOR JHS ENROLMENT";
...
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
	...
	$mysubject=mysqli_query($con,"SELECT * FROM tbl_jhs_subject ORDER BY SequenceNo Asc");
	...
	$pdf->Cell(30,5,"",1,1,'C');
	$pdf->Cell(0,2,"",0,1,'C');
	$pdf->Cell(0,4,"For Transfer Out / JHS Completer Only",0,1);
