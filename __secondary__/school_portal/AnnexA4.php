...
if (isset($_POST['saveannex']))
	{
		mysqli_query($con,"INSERT INTO tbl_sep_annexa4 VALUES('".date("yhmis")."','".$_POST['fund_cluster']."','".$_POST['semi_expendable_property']."','".$_POST['sheetno']."','".$_SESSION['school_id']."')");
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                         ...
                                         <th style="text-align:center;">Semi-expendable Property</th>
                                        <th width="15%" style="text-align:center;">Sheet No.</th>
								...
								<?php
								$no=0;
								$result=mysqli_query($con,"SELECT * FROM tbl_sep_annexa4 WHERE SEP_SchoolID ='".$_SESSION['school_id']."' ORDER BY CardCode Desc");
								while($row=mysqli_fetch_array($result))
								{
								 ...
								 echo '<tr>
											...
											<td style="text-align:center;">'.$row['SheetNo'].'</td>
											<td style="text-align:center;">
											<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['CardCode'])).'&v='.urlencode(base64_encode("view_issued_reports")).'">VIEW</a>
											 <br/><a style="cursor:pointer;" id="'.$row['CardCode'].'" onclick="delete_me(this.id)">DEL</a></td>
				 ...
				 <div class="col-lg-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="text-align:right;overflow-x:auto;height:560px;">
						  <a href="instruction/Annex4.png" target="_blank"><img src="instruction/Annex4.png" style="width:100%;height:500px;"></a>
						  </div>
					</div>
				  </div>
                </div>
...
function delete_me(id)
{
	if (confirm("Are you sure you want to remove entire row?"))
	{
		...
		window.location.href='remove_annexA4.php?id='+id;
	}
}
</script>
     ...
     <div class="modal-dialog">
      ...
      <div class="modal-content">
          <div class="modal-header">
             <h3 class="modal-title"><center>REGISTRY OF SEMI-EXPENDABLE PROPERTY ISSUED</center></h3>
			</div>
		...
		<input type="number" name="sheetno" class="form-control" required>
		</div>
