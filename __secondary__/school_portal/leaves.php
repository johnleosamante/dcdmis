 <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
							<h3> Leaved Personnel Information </h3>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                               <thead>
								...
								<?php
								$no=0;
									$myinfo=mysqli_query($con,"SELECT * FROM  tbl_leave_applied INNER JOIN tbl_employee ON tbl_leave_applied.Emp_ID =tbl_employee.Emp_ID INNER JOIN tbl_leave ON tbl_leave_applied.Type_of_Leave=tbl_leave.LeaveCode INNER JOIN tbl_station ON tbl_leave_applied.Emp_ID = tbl_station.Emp_ID WHERE tbl_leave_applied.Status<>'Rendered' AND tbl_station.Emp_Station ='".$_SESSION['school_id']."'")or die ("Leave Information error");
