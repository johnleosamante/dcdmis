...
echo '<button type="button" class="close" data-dismiss="modal" onclick="window.location.reload()">&times;</button>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Personal Information
							...
							<input type="hidden" name="TIN" value="'.$mydata['Emp_TIN'].'" class="form-control" required>
							<label>ITEM NUMBER:</label>
							<input type="text" name="Item_Number" placeholder="ITEM NUMBER" class="form-control" value="'.$data['Item_Number'].'" required>
							<label>AUTORIZED:</label>
							<input type="text" name="ASalary" placeholder="AUTHORIZED SALARY" class="form-control" value="'.$data['Autorized'].'" required>
							<label>ACTUAL:</label>
							<input type="text" name="Actual" placeholder="ACTUAL SALARY" class="form-control" value="'.$data['Actual'].'" required>
							<label>STEP:</label>
							<input type="text" name="Step" placeholder="STEP" class="form-control" value="'.$data['Step'].'" required>
							<label>JOB STATUS:</label>
							<input type="text" name="JStatus" placeholder="JOB STATUS" class="form-control" value="'.$data['Job_status'].'" required>
							</dl>
							</div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Continue Information
							...
							<input type="date" name="DPromoted" placeholder="DATE PROMOTED" class="form-control" value="'.$data['Date_promoted'].'" required>
							<label>ELEGIBILITY:</label>
							<input type="text" name="PElegibility" placeholder="ELEGIBILITY" class="form-control" value="'.$data['Elegibility'].'" required>
							</dl>
							</div>
                </div>
