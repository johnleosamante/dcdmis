...
if (isset($_POST['saveannex']))
	{
		mysqli_query($con,"INSERT INTO tbl_sep_annexa10 VALUES('".date("yhmis")."','".date("Y-m-d")."','".$_POST['fund_cluster']."','".$_POST['AO']."','".$_POST['Designation']."','".$_SESSION['school_id']."')");
            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="panel panel-default">
					     ...
					     <h4 style="text-transform:uppercase;">Inventory and Inspection Report of unserviceable semi-expendable property<h4>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="20%">Accountable Officer</th>
								...
								<?php
								$no=0;
								$result=mysqli_query($con,"SELECT * FROM tbl_sep_annexa10 WHERE SEP_SchoolID ='".$_SESSION['school_id']."' ORDER BY CardCode Desc");
								while($row=mysqli_fetch_array($result))
								{
								 ...
								 echo '<tr>
											...
											<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['CardCode'])).'&v='.urlencode(base64_encode("view_annex10")).'">VIEW</a>
				 ...
				 <div class="col-lg-3">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="text-align:right;overflow-x:auto;height:560px;">
						  <a href="instruction/Annex10.jpg" target="_blank"><img src="instruction/Annex10.jpg" style="width:100%;height:500px;"></a></div>
					</div>
				  </div>
                </div>
                <!-- /.col-lg-12 -->
...
function delete_me(id)
{
	if (confirm("Are you sure you want to remove entire row?"))
	{
		...
		window.location.href='remove_annexA10.php?id='+id;
	}
}
</script>
