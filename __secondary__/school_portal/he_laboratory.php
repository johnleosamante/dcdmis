<div class="row">
                ...
                <!-- /.col-lg-12 -->
				 ...
				 if (isset($_POST['update_library']))
				 {
					 ...
					 mysqli_query($con,"UPDATE wp_home_economics SET location_details='".$mynewimage."' WHERE SchoolID='".$_SESSION['school_id']."' AND No='".$_SESSION['PicNo']."' LIMIT 1");
				 ...
				 }else if (isset($_POST['Add_library']))
				 {
					 ...
					 move_uploaded_file($temp, $mynewimage);
					 mysqli_query($con,"INSERT INTO wp_home_economics VALUES(NULL,'".$mynewimage."','".$_SESSION['school_id']."')");  
				 ...
				 ?>
					...
					<form action="" Method="POST" enctype="multipart/form-data">
						 ...
						 <?php
						  echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("website")).'" style="float:right;" class="btn btn-secondary">Back</a>';
							 ...
							 <a style="float:right;cursor:pointer;" class="btn btn-success" onclick="add_file()">Add</a>
							   <h4>HOME ECONOMIC LABORATORY</h4>
						   </div>
                        ...
                        <div class="panel-body">
							 ...
							 <?php
								$mymessage=mysqli_query($con,"SELECT * FROM wp_home_economics WHERE SchoolID='".$_SESSION['school_id']."'");
								while ($rowmessage=mysqli_fetch_assoc($mymessage))
								{
								echo '<a href="computer_lab_update.php?id='.urlencode(base64_encode($rowmessage['No'])).'" title="click to change" data-toggle="modal" data-target="#updates_School_lib" ><img src="'.$rowmessage['location_details'].'" style="width:100%;heigh:560px;padding:4px;margin:4px;" id="pic"></a>';
								}
							?> 
...
<div class="panel-body">
	 ...
	 <div class="modal-dialog">
      ...
      <div class="modal-content">
			...
			<h4 class="modal-title" id="myModalLabel">Add New Laboratory Features</h4>
			</div>
			<form action="" method="POST" enctype="multipart/form-data">
