...
if (isset($_POST['saveannex']))
	{
		mysqli_query($con,"INSERT INTO tbl_sep_annexa1 VALUES('".date("yhmis")."','".$_POST['fund_cluster']."','".$_POST['description']."','".$_POST['semi_expendable_property']."','".$_POST['semi_expendable_property_no']."','".$_SESSION['school_id']."')");
                ...
                <div class="col-lg-9">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php
								$no=0;
								$result=mysqli_query($con,"SELECT * FROM tbl_sep_annexa1 WHERE SEP_SchoolID ='".$_SESSION['school_id']."' ORDER BY CardCode Desc");
								while($row=mysqli_fetch_array($result))
								{
								 ...
								 echo '<tr>
											...
											<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['CardCode'])).'&v='.urlencode(base64_encode("view_report_card")).'">VIEW</a> <br/><a style="cursor:pointer;" id="'.$row['CardCode'].'" onclick="delete_me(this.id)">DEL</a></td>
				 ...
				 <div class="col-lg-3">
                    <div class="panel panel-default">
						...
						<a href="instruction/Annex1.png" target="_blank"><img src="instruction/Annex1.png" style="width:100%;height:500px;"></a>
						  </div>
					</div>
				  </div>
                </div>
...
function delete_me(id)
{
	if (confirm("Are you sure you want to remove entire row?"))
	{
		...
		window.location.href='remove_annexA1.php?id='+id;
	}
}
</script>
