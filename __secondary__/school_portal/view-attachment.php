   ...
   include("../vendor/jquery/function.php");
	...
	$posted=mysqli_query($con,"SELECT * FROM post INNER JOIN tbl_employee ON post.posted_by=tbl_employee.Emp_ID  WHERE post.id = '".$data2."' ORDER BY post.date_posted Desc");
	$row=mysqli_fetch_assoc($posted);
	$_SESSION['chat-id']=$data2;
	echo ' <div class="modal-header">
        ...
        <div class="modal-body">
			<ul class="chat">
			  ...
			  echo '<hr/><div id="reply" style="height:auto;overflow-x:auto;"></div>
