...
$pdf->Image($img1,97,145,20);
	...
	$vehicle=mysqli_query($con,"SELECT * FROM tbl_vehicle_reservation INNER JOIN tbl_vehicle ON tbl_vehicle_reservation.VehicleCode = tbl_vehicle.VehicleCode WHERE tbl_vehicle_reservation.No='".$_SESSION['updatevehicle']."' LIMIT 1") or die("Table Error");
