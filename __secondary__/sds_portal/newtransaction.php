                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                         <div class="panel-heading">
							...
							{
							mysqli_query($con,"INSERT INTO tbl_transactions VALUES ('".$_POST['Qualicode']."','".$_POST['Qualname']."','".$dateposted."','OSDS','".$_POST['status']."','Unread','123131')");
      ...
      <div class="modal-content">
		...
		<img src="../logo/check.png" width="100%" height="50%">
		 ...
		 <?php
			...
			echo '<a href="./?7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&'.sha1("Pagadian City Division BUREAU of EDUCATION assessment!").'&v='.urlencode(base64_encode("transaction")).'" class="btn btn-primary"> OK</a>';
