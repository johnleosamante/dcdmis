...
if (mysqli_affected_rows($con)==1)
{
 ...
 mysqli_query($con,"INSERT INTO tbl_communication_logs VALUES(NULL,'".$dateposted."','".$_SESSION['station']."','".$_POST['section']."','".$_SESSION['uid']."','".$_POST['actiontaken']."','".$_GET['MemoNo']."')");
 ?>
	 ...
	 <div class="modal-dialog">
      ...
      <div class="modal-content">
			...
			<label>Forward to:</label><br/>
				...
				<textarea class="form-control" name="actiontaken" rows="3"></textarea>
		   	</div>
