		...
		text-transform:uppercase;
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						echo'<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("transaction")).'" class="btn btn-secondary" style="float:right;">Back</a>
                       <!-- /.panel-heading -->
                        <div class="panel-body">
						...
						$data=mysqli_query($con,"SELECT * FROM tbl_transactions_log INNER JOIN tbl_employee ON tbl_transactions_log.Recieved_by = tbl_employee.Emp_ID WHERE tbl_transactions_log.Transaction_code='".$_GET['id']."'");
						 while($row=mysqli_fetch_array($data))
						 {
							 ...
							 echo '<tr>
										...
										<td><a href="update-trans.php?id='.$row['No'].'&Code='.$row['Transaction_code'].'" data-target="#Myupdate" data-toggle="modal">Edit</a></td>
									</tr>';
						 }
						?>	
