                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                         <div class="panel-heading">
						  <a href="#newtrack" class="btn btn-default" style="float:right;" data-toggle="modal" Title="Add New Transaction"><i class="fa fa-comments fa-fw"></i>New Transaction</a>
							...
							if (isset($_POST['new_transaction']))
							{
								...
								mysqli_query($con,"INSERT INTO tbl_transactions VALUES ('".$_POST['Qualicode']."','".$dataA."','".$dateposted."','OSDS','".$_POST['status']."','Unread','123131','')");
							
								if (mysqli_affected_rows($con)==1)
								{
									mysqli_query($con,"INSERT INTO tbl_transactions_log VALUES (NULL,'".$dateposted."','".$_SESSION['uid']."','OSDS','".$_POST['first']."','".$_POST['status']."','".$_POST['Qualicode']."','New')");
                        ...
                        <div class="panel-body">
							...
							$tot=$totm=$totf=0;
								...
								echo '<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>';
										$no=0; 
										$datereg=mysqli_query($con,"SELECT * FROM tbl_transactions  WHERE Trans_Stats<>'COMPLETED' ORDER BY Date_time Desc LIMIT 500");
											while($row=mysqli_fetch_array($datereg))
										{
											...
											echo '<tr>
													...
													<td style="text-align:center;">'.$row['Trans_from'].'</td>
													<td style="text-align:center;">'.$row['Trans_Stats'].'</td>
													<td style="text-align:center;">';
														
														  echo '<a href="print-transaction.php?link='.sha1("Deped Data Management System v.1.0").'&&Code='.urlencode(base64_encode($row['TransCode'])).'" target="_blank" title="Print Transaction" class="btn btn-primary" style="padding:4px;margin:4px;"> <i class="fa fa-print fa-fw"></i></a>';		
														...
														echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&id='.urlencode(base64_encode($row['TransCode'])).'&v='.urlencode(base64_encode("view_log")).'" title="View Transaction Logs" class="btn btn-info" style="padding:4px;margin:4px;"> <i class="fa fa-desktop fa-fw"></i></a>
																<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&id='.urlencode(base64_encode($row['TransCode'])).'&v='.urlencode(base64_encode("update_transaction")).'" title="Update Transaction" class="btn btn-warning" style="padding:4px;margin:4px;">  <i class="fa fa-pencil-square-o fa-fw"></i></a>
																
																<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&id='.urlencode(base64_encode($row['TransCode'])).'&v='.urlencode(base64_encode("canceled_transaction")).'" title="Cancelled Transaction" class="btn btn-danger" style="padding:4px;margin:4px;"> <i class="fa fa-trash-o fa-fw"></i></a>';
   ...
   <div class="panel-body">
     ...
     <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		$query=mysqli_query($con,"SELECT * FROM tbl_transactions WHERE TransCode='".$code."' AND Trans_from='".$_SESSION['station']."'");
