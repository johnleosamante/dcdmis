                    ...
                    <div class="panel panel-default">
                       <div class="panel-heading">
					    <a href="#mytraining" class="btn btn-primary" style="float:right;" data-toggle="modal">New activity</a>
							...
							{
							mysqli_query($con,"INSERT INTO tbl_seminar VALUES('".$_POST['Tcode']."','".$_POST['TTitle']."','".$_POST['TFrom']."','".$_POST['TTo']."','".$_POST['TConduct']."','".$_POST['TVenue']."','-','".$_POST['TOffice']."','-','".$_POST['category']."','','')");
									...
									$seminar=mysqli_query($con,"SELECT * FROM tbl_seminar WHERE Office='".$_SESSION['station']."'") or die ("error training data");
										...
										echo '<tr><td style="text-align:center;">'.$no.'</td>
												...
												<td class="dropdown" style="text-align:center;">
													 <a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['Training_Code'])).'&v='.urlencode(base64_encode("view_list")).'" Title="View Training" class="btn btn-primary" style="padding:2px;margin:2px;"> <i class="fa fa-desktop fa-fw"></i></a>
													 <a href="edit-training.php?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['Training_Code'])).'" data-toggle="modal" data-target="#editfile" Title="Update Training" class="btn btn-info" style="padding:2px;margin:2px;"> <i class="fa fa-pencil-square-o fa-fw"></i></a>
													 <a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($row['Training_Code'])).'&v='.urlencode(base64_encode("other_list")).'" Title="View Speaker" class="btn btn-warning" style="padding:2px;margin:2px;"> <i class="fa fa-users fa-fw"></i></a>
													  <a onclick="delete_me(this.id)" id="'.$row['Training_Code'].'" class="btn btn-warning" style="padding:2px;margin:2px;cursor:pointer;"> <i class="fa fa-trash-o fa-fw"></i></a>										 
