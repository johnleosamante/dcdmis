...
include("../../../pcdmis/vendor/jquery/function.php");
		...
		require_once '../../Classes/PHPExcel.php';
	     ...
	     $filename = 'Alphabetical Order'; //your file name
		...
		//Get data from the database
			...
			{	
			  $result=mysqli_query($con,"SELECT * FROM tbl_applicant INNER JOIN tbl_applicant_rating ON tbl_applicant.Appl_No=tbl_applicant_rating.ApplicanNo WHERE tbl_applicant.Status <> 'OLD'  AND tbl_applicant.Category='".$_SESSION['ApplicantCat']."' AND tbl_applicant.Major LIKE '%".$rowsub['RankSubject']."%' ORDER BY tbl_applicant.Major,tbl_applicant.Last_Name Asc");
			}else{
			 $result=mysqli_query($con,"SELECT * FROM tbl_applicant INNER JOIN tbl_applicant_rating ON tbl_applicant.Appl_No=tbl_applicant_rating.ApplicanNo WHERE tbl_applicant.Status <> 'OLD'  AND tbl_applicant.Category='".$_SESSION['ApplicantCat']."' AND tbl_applicant.Major = '".$rowsub['RankSubject']."'ORDER BY tbl_applicant.Major,tbl_applicant.Last_Name Asc");
