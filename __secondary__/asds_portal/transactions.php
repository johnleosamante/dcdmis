                    ...
                    <div class="panel panel-default">
                         <div class="panel-heading">
						  <a href="#newtrack" class="btn btn-primary" style="float:right;" data-toggle="modal">New Transaction</a>
							...
							mysqli_query($con,"INSERT INTO tbl_transactions VALUES ('".$_POST['Qualicode']."','".$dataA."','".$dateposted."','ASDS','".$_POST['status']."','Unread','123131','')");
								
								if (mysqli_affected_rows($con)==1)
								{
								mysqli_query($con,"INSERT INTO tbl_transactions_log VALUES (NULL,'".$dateposted."','".$_SESSION['uid']."','ASDS','".$_POST['first']."','".$_POST['status']."','".$_POST['Qualicode']."','New')");
                        ...
                        <div class="panel-body">
							...
							$tot=$totm=$totf=0;
								...
								echo '<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>';
										$no=0; 
										$datereg=mysqli_query($con,"SELECT * FROM tbl_transactions WHERE tbl_transactions.Trans_from='".$_SESSION['station']."' ORDER BY tbl_transactions.Date_time Desc");
   ...
   <div class="panel-body">
     ...
     <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		$num=mysqli_num_rows($result)+ date("ms");
		if ($num>=0 AND $num<=9)
		{
		...
		<label style="padding:4px;">Destination (Select Section)</label><br/>
		   <div class="row">
			...
			<div class="form-group">
				...
				<label class="checkbox-inline">
                      <input type="radio"  name="status" id="status" value="For Memo No. " required > For Memo No.
