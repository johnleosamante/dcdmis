...
include("../../../pcdmis/vendor/jquery/function.php");
		...
		require_once '../../Classes/PHPExcel.php';
	     ...
	     $filename = 'Highest-Lowest Order'; //your file name
		...
		//First Subject Araling Panlipunan
		//Center Alignment
		...
		//Get data from the database
			...
			{	
			  $result=mysqli_query($con,"SELECT * FROM tbl_applicant INNER JOIN tbl_applicant_rating ON tbl_applicant.Appl_No=tbl_applicant_rating.ApplicanNo WHERE tbl_applicant.Status <> 'OLD'  AND tbl_applicant.Category='".$_SESSION['ApplicantCat']."' AND tbl_applicant.Major LIKE '%".$rowsub['RankSubject']."%' ORDER BY tbl_applicant.Major,tbl_applicant_rating.OverALL Desc");
			}else{
			 $result=mysqli_query($con,"SELECT * FROM tbl_applicant INNER JOIN tbl_applicant_rating ON tbl_applicant.Appl_No=tbl_applicant_rating.ApplicanNo WHERE tbl_applicant.Status <> 'OLD'  AND tbl_applicant.Category='".$_SESSION['ApplicantCat']."' AND tbl_applicant.Major = '".$rowsub['RankSubject']."'ORDER BY tbl_applicant.Major,tbl_applicant_rating.OverALL Desc");
			...
			//$rowrate=mysqli_fetch_assoc($myrating);
				...
				$objPHPExcel->setActiveSheetIndex(0) 
					...
					->setCellValue('U'.$no, number_format($row['OverALL'],2))
					;	
