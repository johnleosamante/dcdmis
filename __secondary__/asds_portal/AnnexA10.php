                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						?>
					     ...
					     <h4>INVENTORY AND INSPECTION REPORTS OF UNSERVICEABLE SEMI-EXPENDABLE PROPERTY (ANNEX A10)<h4>
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								<?php
								$no=0;
								$result=mysqli_query($con,"SELECT * FROM tbl_sep_annexa10 WHERE SEP_SchoolID ='".$_SESSION['current_id']."' ORDER BY CardCode Desc");
								while($row=mysqli_fetch_array($result))
								{
								 ...
								 echo '<tr>
											...
											<td style="text-align:center;"><a href="print_annexA10.php?code='.urlencode(base64_encode($row['CardCode'])).'" target="_blank"">VIEW</a></td>
