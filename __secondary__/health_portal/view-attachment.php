   ...
   include("../vendor/jquery/function.php");
	...
	$posted=mysqli_query($con,"SELECT * FROM post INNER JOIN tbl_employee ON post.posted_by=tbl_employee.Emp_ID  WHERE post.chatID = '".$encript_2."' ORDER BY post.date_posted Desc");
