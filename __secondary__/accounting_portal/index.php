...
$mysched = DBQuery("SELECT * FROM tbl_distribution_schedule");
$rowdata =DBFetchAssoc($mysched);
	...
	<div id="wrapper">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="navbar-header">
				...
				<?php include('../_includes_/layout/navbar-brand.php'); ?>
			</div>
		...
		<div id="page-wrapper">
			...
			<div class="row" style="margin-top: 20px;">
				...
				if (!isset($url)) {
					...
					} elseif ($url == 'provident') {
						include("provident_loan.php");
					} elseif ($url == 'provident_account') {
						include("provident_account.php");
					} elseif ($url == 'loan_ledger') {
						include("ledger.php");
					} elseif ($url == 'history') {
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<h3 class="text-center">Transaction has a problem!!!</h3>
			</div>
...
<div class="modal fade" id="verifier" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<img src="../pcdmis/logo/check.png" width="100%" height="50%">
				<h3 class="text-center">Transaction Successfully Submitted</h3>
			</div>
