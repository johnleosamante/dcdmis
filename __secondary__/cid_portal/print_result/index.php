...
//$pdf->Image($img4,90,240,120);
	...
	$pdf->Cell(25,5,$rowscore['One'],1,0,'C');
	
	//Teaching data
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"Gen T E.(12): ",0,0);
	$pdf->Cell(25,5,$rowscore['Five'],1,0,'C');
	
	//LET Data
	$pdf->Cell(15,5,"",0,0);
	$pdf->Cell(25,5,"Rating: ",0,0);
	$pdf->Cell(25,5,$rowscore['Eight'],1,1,'C');
	
	//Education information
	$pdf->Cell(0,2,'',0,1);
	$pdf->Cell(30,5,"Equivalent(18): ",0,0);
	$pdf->Cell(25,5,$rowscore['EdEquiv'],1,0,'C');
	
	//Teaching data
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"KVT/ LGU(3): ",0,0);
	$pdf->Cell(25,5,$rowscore['Six'],1,0,'C');

    //LET Data
	$pdf->Cell(15,5,"",0,0);
	$pdf->Cell(25,5,"Equivalent(15): ",0,0);
	$pdf->Cell(25,5,$rowscore['RateEquive'],1,1,'C');

   //Education information
	$pdf->Cell(0,2,'',0,1);
	$pdf->Cell(30,5,"MA/PhD(2): ",0,0);
	$pdf->Cell(25,5,$rowscore['Three'],1,0,'C');
	
	//Teaching data
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"Gen T E.(12): ",0,0);
	$pdf->Cell(25,5,$rowscore['Five'],1,1,'C');
	
	//Education information
	$pdf->Cell(0,2,'',0,1);
	$pdf->Cell(30,5,"Sub Total(20): ",0,0);
	$pdf->Cell(25,5,$rowscore['EdSubTotal'],1,0,'C');
	
	//Teaching data
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"Sub Total(15): ",0,0);
	$pdf->Cell(25,5,$rowscore['TeachSubTotal'],1,1,'C');
	$pdf->Cell(0,10,'',0,1);
	...
	$pdf->Cell(25,5,$rowscore['Ten'],1,0,'C');
	
	//English Information
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"Rating ",0,0);
	$pdf->Cell(25,5,$rowscore['Fifteen'],1,1,'C');
	$pdf->Cell(0,2,'',0,1);
	
	//Specialized data
	$pdf->Cell(35,5,"Demo (5)",0,0);
	$pdf->Cell(25,5,$rowscore['Eleven'],1,0,'C');
	
	//English Information
	$pdf->Cell(20,5,"",0,0);
	$pdf->Cell(30,5,"Equivalent (15) ",0,0);
	$pdf->Cell(25,5,$rowscore['EngEval'],1,1,'C');
	$pdf->Cell(0,2,'',0,1);
	
	//Specialized data
	$pdf->Cell(35,5,"Sub Total (10)",0,0);
	$pdf->Cell(25,5,$rowscore['SpecialSubTotal'],1,1,'C');
	$pdf->Cell(0,2,'',0,1);	
	
		
	//Specialized data
	$pdf->Cell(35,5,"Interview (10)",0,0);
	$pdf->Cell(25,5,$rowscore['Thirteen'],1,1,'C');
	$pdf->Cell(0,2,'',0,1);	
	
	//Specialized data
	$pdf->Cell(35,5,"Demo Teachng (15)",0,0);
	$pdf->Cell(25,5,$rowscore['Fourteen'],1,1,'C');
	$pdf->Cell(0,5,'',0,1);	
	$pdf->Cell(0,0,'',1,1);	
	$pdf->Cell(0,5,'',0,1);	
	 $grandtotal= $rowscore['EdSubTotal'] + $rowscore['TeachSubTotal'] + $rowscore['RateEquive'] + $rowscore['SpecialSubTotal'] + $rowscore['EngEval']+ $rowscore['Thirteen']+ $rowscore['Fourteen'];
						  
	$pdf->SetFont('Arial','B',10);
	$pdf->Cell(150,5,"Grand Total:",0,0);
	$pdf->Cell(40,5,number_format($grandtotal,2),1,1,'C');
	$pdf->Cell(0,5,'',0,1);	
	$pdf->SetFont('Arial','',10);
