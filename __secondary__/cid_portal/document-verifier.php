                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						if (isset($_POST['dts']))
							...
							{
								if ($_POST['transfinding']<>"")
								{
									$remark=$_POST['status'].'-'.$_POST['transfinding'];
									mysqli_query($con,"UPDATE tbl_transactions SET Trans_Stats='".$remark."' WHERE TransCode='".$_SESSION['Transcode']."' LIMIT 1");	
