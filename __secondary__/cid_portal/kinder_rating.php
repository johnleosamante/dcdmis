                    ...
                    <div class="panel panel-default">
					 ...
					 <?php
					  ...
					  <form action="" Method="POST" enctype="multipart/form-data">
						...
						<input type="text" name="DemoTeach" class="form-control" value="<?php echo $rowscore['Fourteen']; ?>" required>
						
						<label>Mother Tongue (5)</label>
						<input type="text" name="MotherTongue" class="form-control" value="<?php echo $rowscore['MotherTongue']; ?>" required>
						<label>Sub Total </label>
						<input type="text" name="dmtsubtotal" class="form-control" value="<?php echo  $demtotal; ?>" required disabled>
