				 ...
				 <div class="col-lg-12">
				  ...
				  <?php
					...
					$_SESSION['ApplicantCat']="KINDER";
				  if (isset($_POST['save_element']))
				  {
					  mysqli_query($con,"INSERT INTO tbl_applicant VALUES('".date("ydms")."','".$_POST['FName']."','".$_POST['GName']."','".$_POST['MName']."','".$_POST['sex']."','".$_POST['CellNo']."','".$_POST['homeaddress']."','KINDER','".$_SESSION['year']."','-','".$_POST['Status']."')");
				  ...
				  ?>
						...
						<div class="col-lg-1">
						  <a href="print_all_kinder/" class="btn btn-info" style="padding:4px;margin:4px;" target="_blank">PRINT ALL</a>
						  <a href="print_rqa_kinder/" class="btn btn-danger" style="padding:4px;margin:4px;" target="_blank">PRINT RQA</a>
