...
$pdf->Image($img1,50,10,20);
	...
	$pdf->Cell(0,5,date("Y").' RQA FOR ELEMENTARY SCHOOL TEACHER 1 POSITION',0,1,'C');
	...
	$result=mysqli_query($con,"SELECT * FROM tbl_applicant WHERE Status <> 'OLD' AND Category='ELEMENTARY' ORDER BY Last_Name Asc");
	...
	$myrank=mysqli_query($con,"SELECT * FROM tbl_rqa_list INNER JOIN tbl_applicant ON tbl_rqa_list.ApplicantNo = tbl_applicant.Appl_No WHERE tbl_applicant.Status <> 'OLD' AND tbl_applicant.Category='ELEMENTARY' ORDER BY tbl_rqa_list.Scores Desc");
