<div class="modal-header">
          ...
          <h3 class="modal-title"><center>Update Downloadable file</center></h3>
		  	
        </div>
		<form action="update-file.php?link=b65d14a30bd76c1c7355c4dde7773181724cda4c" Method="POST" ENCTYPE="multipart/form-data">
		...
		$mypost=mysqli_query($con,"SELECT * FROM tbl_downloads WHERE tbl_downloads.FileCode='".$_GET['id']."' LIMIT 1");
