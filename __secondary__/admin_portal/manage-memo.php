            ...
            <div class="row">
                 <div class="col-lg-12">
                    <div class="panel panel-default">
						 ...
						 <a href="#newmemo" style="float:right;" class="btn btn-primary" data-toggle="modal">New Memo</a>                      
						 	<h4> List of Division Memo</h4>
						...
						<tr>
							...
							<th width="7%"></th>
                              ...
                              <?php
					$no=0;
					$result=mysqli_query($con,"SELECT * FROM tbl_memos INNER JOIN tbl_user ON tbl_memos.Emp_ID = tbl_user.usercode");
							...
							<td class="dropdown" style="text-align:center;">
										...
										<a class="dropdown-toggle" data-toggle="dropdown" href="#">
											...
											<ul class="dropdown-menu dropdown-user">
												...
												<li><a href="edit-memo.php?id='.$row['FileCode'].'" data-target="#mypost" data-toggle="modal"><i class="fa fa-edit fa-fw"></i> Edit</a>
													</li>
												<li><a href="removed-memo.php?id='.$row['FileCode'].'"><i class="fa fa-trash-o fa-fw"></i> Trash</a>
												</li>
    ...
    <!-- Modal -->
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h3 class="modal-title"><center>Upload new memo</center></h3>
		  	
        </div>
		       
		<form ENCTYPE="multipart/form-data" action="save-memo-file.php" Method="POST">
