<div class="modal-header">
          ...
          <h3 class="modal-title"><center>Update Announcement</center></h3>
		  	
        </div>
		<form action="announcement.php?link=b65d14a30bd76c1c7355c4dde7773181724cda4c" Method="POST">
		...
		$mypost=mysqli_query($con,"SELECT * FROM post WHERE post.id='".$_GET['id']."' LIMIT 1");
