...
$str=sha1("Dipolog City Division Management information system");
?>
...
<head>
    ...
    <meta name="description" content="">
      <title>DepEd Dipolog City Division Manangement Information System</title>
            ...
            <div class="row" style="margin-top: 20px;">
                 <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<form action="print-dtr-all.php?url=%278ea8355b2e55b6c656245ba15d7fffb3aa1841b9%27" method="POST">
						  <h2>Print all Daily Time Record</h2>
                            <label>From</label>
                            <input type="date" name="date_from" class="form-control">
							<label>To</label>
                            <input type="date" name="date_to" class="form-control"><hr>
							<input type="submit" name="search" value="Print Preview" class="btn btn-primary">
							</form>
                        </div>
                        <!-- /.panel-body -->
                    </div>
