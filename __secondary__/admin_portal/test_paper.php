...
//Learner Information
 ...
 $Middle=mb_strimwidth($rowname['MName'],0,1);
	...
	$pdf->Cell(70,7,utf8_decode(strtoupper($rowname['FName'].' '.$Middle.'. '.$rowname['Lname'])),0,0);
	$pdf->Cell(30,7,'GRADE LEVEL: ',0,0);
	$pdf->Cell(25,7,'GRADE '.$_GET['YLevel'],0,1);
	$pdf->Cell(30,7,'SCHOOL NAME:  ',0,0);
	$pdf->Cell(0,7,strtoupper( $_GET['SchoolName']),0,1);
	$pdf->Cell(0,3,'',0,1);
...
$pdf->Cell(170,10,"TOTAL: ",1,0);
	...
	//Generated
	//$pdf->Cell(0,5,'System Generated: PCDMIS',0,1);
