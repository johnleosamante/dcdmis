...
<div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel">Picture for the question number <?php echo $_SESSION['No']; ?></h4>
			</div>
		   ...
		   <button type="submit" class="btn btn-success" name="AddPicture">ADD</button>
		 </div>	
		 </form>