                           ...
                           <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									while($row=mysqli_fetch_array($result))
									{
										...
										echo '<tr>
												...
												<td>'.$row['Major'].'</td>
												<td>'.$row['Status'].'</td>
												<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&account='.urlencode(base64_encode($row['Appl_No'])).'&Category='.urlencode(base64_encode("SECONDARY")).'&v='.urlencode(base64_encode("individual_rating")).'" title="View Applicant Profile"><i class="fa fa-desktop fa-fw"></i></a> 
												    </td>
												 </tr>';
									}
									?>
