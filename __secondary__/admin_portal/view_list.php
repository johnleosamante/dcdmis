									...
									<a href="#newtemplate" class="btn btn-primary" style="float:right;" data-toggle="modal">Upload Certificate</a>
									   ...
									   echo '<label>Title of Training: </label>'.$row['Title_of_training'].'<br/>
											...
											<label>Conducted by: </label> '.$row['conducted_by'].'<hr/>';
											 ...
											 echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($_GET['code'])).'&v='.urlencode(base64_encode("list_of_attendance")).'" class="btn btn-info" style="float:right;"> Attendance</a>';
