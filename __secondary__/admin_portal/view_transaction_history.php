  <div class="modal-header">
          ...
          <h3 class="modal-title"><center>Transaction Details</center></h3>
        ...
        <div class="modal-body">
		 ...
		 session_start();
		   include("../../pcdmis/vendor/jquery/function.php");
			...
			$mystatus=mysqli_query($con,"SELECT * FROM tbl_transactions WHERE  TransCode='".$id."' AND Trans_Stats <>'Done' LIMIT 1");
			$row=mysqli_fetch_assoc($mystatus);
				...
				<tr>
					...
					<tbody>
						...
						$no=0;
						$data=mysqli_query($con,"SELECT * FROM tbl_transactions_log INNER JOIN tbl_employee ON tbl_transactions_log.Recieved_by = tbl_employee.Emp_ID WHERE tbl_transactions_log.Transaction_code='".$id."'");
