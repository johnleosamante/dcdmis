...
include_once('../../pcdmis/code128.php');
...
$pdf->Cell(0, 25, '', 0, 1);
$pdf->Cell(0, 5, 'LOURMA I. POCULAN, CESE', 0, 1, 'C');
$pdf->Cell(0, 5, 'Assistant Schools Division Superintendent', 0, 1, 'C');
