...
{
mysqli_query($con,"UPDATE tbl_memo_notification SET MemoStatus='Read' WHERE MemoNo='".$_GET['MemoNo']."' AND MemoTo='".$_SESSION['station']."' LIMIT 1");
if (mysqli_affected_rows($con)==1)
{
mysqli_query($con,"INSERT INTO tbl_communication_logs VALUES(NULL,'".$dateposted."','".$_SESSION['station']."','-','".$_SESSION['uid']."','".$_POST['actiontaken']."','".$_GET['MemoNo']."')");
...
<h1></h1>
                             ...
                             <div class="col-lg-6">
								 ...
								 <hr/>
								  ...
								  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>';
										$memodetail=mysqli_query($con,"SELECT * FROM tbl_communication_logs WHERE MemoNo='".$_GET['MemoNo']."'");
										while($rowmemo=mysqli_fetch_array($memodetail))
										{
											echo '
											<tr>
												<td>'.$rowmemo['Date_created'].'</td>
												<td>'.$rowmemo['From_office'].'</td>
												<td>'.$rowmemo['Forward_To'].'</td>
												<td>'.$rowmemo['MemoRemarks'].'</td>
											</tr>	';
										}
										echo '</tbody>
	 ...
	 <div class="modal-dialog">
      ...
      <div class="modal-content">
			...
			<label>Remarks:</label>
				<textarea class="form-control" rows="3" name="actiontaken" required></textarea>
		   	</div>
           <div class="modal-footer">
		   <input type="submit" name="save_remark" class="btn btn-primary" value="Take Action"/>
