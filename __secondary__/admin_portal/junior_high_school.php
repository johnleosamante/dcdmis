 <table width="100%" class="table table-striped table-bordered table-hover">
									...
									//GRADE 7
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("7")).'&v='.urlencode(base64_encode("view-school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("8")).'&v='.urlencode(base64_encode("view-school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("9")).'&v='.urlencode(base64_encode("view-school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("10")).'&v='.urlencode(base64_encode("view-school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
