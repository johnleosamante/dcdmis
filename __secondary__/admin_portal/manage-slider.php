            ...
            <div class="row">
                 <div class="col-lg-12">
                    <div class="panel panel-default">
						 ...
						 <a href="#newvideo" style="float:right;" class="btn btn-primary" data-toggle="modal">New Slider</a>                      
						 	<h4> List of Image Slider</h4>
                        </div>
					...
					$no=0;
					$result=mysqli_query($con,"SELECT * FROM slider_img INNER JOIN tbl_user ON slider_img.postedby = tbl_user.usercode");
							...
							<td class="dropdown" style="text-align:center;">
										...
										<a class="dropdown-toggle" data-toggle="dropdown" href="#">
											...
											<ul class="dropdown-menu dropdown-user">
												...
												<li><a href="removed-slider.php?id='.$row['id'].'"><i class="fa fa-trash-o fa-fw"></i> Trash</a>
												</li>
...
<div class="panel-body">
    ...
    <!-- Modal -->
      ...
      <div class="modal-content">
		...
		<form ENCTYPE="multipart/form-data" action="save-upload-image.php" Method="POST">
        <div class="modal-body">
		
		<label>Date Posted:</label><span class="error">* </span>
		<input type="text" name="Dposted" class="form-control" value="<?php 
		...
		<label>SubTitle: <span class="error">* </span></label>
		<input type="text" name="File_sub" class="form-control" placeholder="Enter Sub Title" required><br/>
		<label>Attach Image: <span class="error">* </span></label>
		<input type="file" name="images" onchange="loadFile(event)" required>
		<img src="../../images/infographics/pagadian city.jpg" width="100%" height="150"   style="padding:4px;margin:4px;border-radius:10px;" id="pic">
