		...
		<div id="page-wrapper">
			...
			<div class="row" style="margin-top: 20px;">
				...
				if (!isset($url)) {
					...
					if ($url == 'dashboard') {
					...
					} elseif ($url == 'monthly_salary') {
						include("monthly_salary.php");
					} elseif ($url == 'f7_view_payroll') {
						include("f7_view_payroll.php");
					} elseif ($url == 'view_payroll_record') {
						include("f7_view_list.php");
					} elseif ($url == 'add_personnel') {
						include("add_f7_personnel.php");
					} elseif ($url == 'settings') {
						include("setting.php");
						...
						include("steps.php");
					} elseif ($url == 'stepapproval') {
						include("approval.php");
					} elseif ($url == 'salary_grade') {
						include("salary_grade.php");
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title">
						<center>Successfully Save!</center>
					</h3>
				...
				<div class="modal-body">
					...
					<center>
						<img src="../pcdmis/logo/check.png" width="100%" height="50%">
						<h4>Do you want to add more personnel?</h4>
						<?php

						echo '<a href="" class="btn btn-primary" style="padding:4px;margin:4px;"> YES</a>';
						echo '<a href="./?' . $str . '7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&Code=' . urlencode(base64_encode($_GET['Code'])) . '&v=' . urlencode(base64_encode("view_payroll_record")) . '" class="btn btn-warning" style="padding:4px;margin:4px;"> NO</a>';
