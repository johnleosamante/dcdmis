...
?>
		...
		<label>Destination (Select Sections)</label>
           <div class="form-group">
			...
			<div class="form-group">
			<label class="checkbox-inline">
                      <input type="radio"  name="status" value="For ADA Prooflist" required> For ADA Prooflist
                </label> 
			</div>	
			<textarea name="transfinding" id="myfinding" cols="75%" rows="2%" disabled></textarea></div>
