				 ...
				 <div class="col-lg-12">
				  ...
				  <h2>List of Senior High applicants</h2>
				  <?php
					 date_default_timezone_set("Asia/Manila");
					$dateposted = date("Y-m-d H:i:s");
					$_SESSION['ApplicantCat']="SENIOR HIGH";
				  if (isset($_POST['save_element']))
				  {
					  mysqli_query($con,"INSERT INTO tbl_applicant VALUES('".date("ydms")."','".$_POST['FName']."','".$_POST['GName']."','".$_POST['MName']."','".$_POST['sex']."','".$_POST['CellNo']."','".$_POST['homeaddress']."','SENIOR HIGH','".$_SESSION['year']."','".$_POST['Major']."','".$_POST['Status']."','')");
				  ...
				  ?>
						...
						<div class="col-lg-11">
                           <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<?php
									$no=0;
									$result=mysqli_query($con,"SELECT * FROM tbl_applicant WHERE Category='SENIOR HIGH' ORDER BY Last_Name Asc");
						...
						<div class="col-lg-1">
						  <a href="print_all/" class="btn btn-info" style="padding:4px;margin:4px;" target="_blank">PRINT ALL</a>
						  <a href="#major" class="btn btn-warning" style="padding:4px;margin:4px;" data-toggle="modal">BY MAJOR</a>
						  <a href="print_rqa/" class="btn btn-danger" style="padding:4px;margin:4px;" target="_blank">PRINT RQA</a>
			...
			$no=0;
			  ...
			  while($rowsub=mysqli_fetch_array($subject))
			  {
				...
				echo '<tr>
					  ...
					  <td><a href="print_by_major.php?code='.urlencode(base64_encode($rowsub['RankSubject'])).'" target="_blank"><i class="fa  fa-print fa-fw"></i></a></td>
				  </tr>';		 
			  }
			  ?>
			</tbody>
