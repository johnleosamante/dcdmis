				 ...
				 <div class="col-lg-12">
				  ...
				  ?>
						...
						<div class="col-lg-1">
						  ...
						  <a href="print_sds_copy/" class="btn btn-danger" style="padding:4px;margin:4px;" target="_blank">SDS COPY</a>
