								...
								echo '<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										while($payrow=mysqli_fetch_array($mypayroll))
										{
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&PayCode='.urlencode(base64_encode($payrow['PayrollCode'])).'&v='.urlencode(base64_encode("view_payroll")).'" title="View Payroll"><i class="fa  fa-desktop  fa-fw"></i></a></td>
												</tr>';
										}
