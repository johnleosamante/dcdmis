...
#myBar {
  ...
  background-color: #4CAF50;
   ...
   if(isset($_POST['new_assign']))
				...
				mysqli_query($con,"INSERT INTO tbl_deployment_history(Date_assignment,station_assign,position_assign,No_of_years,StepNo,Emp_ID) VALUES('".$_POST['date_order']."','".$_POST['station']."','".$_POST['position']."','".$year."','".$_POST['step']."','".$_SESSION['per_id']."')");
				...
				}elseif(isset($_POST['Create']))
				{
					...
					mysqli_query($con,"INSERT INTO tbl_user VALUES('".$_SESSION['per_id']."','".$_POST['uname']."','".$_POST['upass']."','".$_POST['position']."','HRMO','Default','".$dateposted."','Offline','hrmo_portal')")or die ("error users");	
				if (mysqli_affected_rows($con)==1)
						{
							?>
								<script type="text/javascript">
                    ...
                    <div class="panel panel-default">
						...
						<?php
						echo '<a href="my_deployment.php?id='.urlencode(base64_encode($row['Emp_ID'])).'"" data-toggle="modal" data-target="#my_deployment" class="btn btn-info" title="Deployment History">Deployment History </a>
															
						<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&c='.urlencode(base64_encode($row['Emp_ID'])).'&v='.urlencode(base64_encode("service_record")).'" class="btn btn-danger">Service Record</a>
						<a href="newaccount.php?id='.urlencode(base64_encode($row['Emp_ID'])).'"" data-toggle="modal" data-target="#my_account" class="btn btn-warning">PCDMIS Account</a>';
						?>
						</div>
                        ...
                        <div class="panel-body">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <li>
								 ...
								 <li>
									<a href="#questioners-background" data-toggle="tab">Questionnaires</a>
                                </li>
								 <li>
                                ...
                                <div class="tab-pane fade" id="family-background">
									...
									<div style="overflow-x:auto;width:100%;">
										...
										$result1=mysqli_query($con,"SELECT * FROM family_background WHERE Emp_ID='".$_SESSION['EmpID']."'");
											...
											{
											echo '<tr>
											         <td style="text-align:center;">'.$row1['Family_Name'].'</td>
                                ...
                                <div class="tab-pane fade" id="education-background">
                                  ...
                                  <table width="100%" class="table table-striped table-bordered table-hover">
										...
										$result2=mysqli_query($con,"SELECT * FROM educational_background WHERE Emp_ID='".$_SESSION['EmpID']."'");
											...
											{
											echo '<tr>
											         <td style="text-align:center;">'.$row2['Level'].'</td>
...
<style>
   ...
   .deploy{
	   width:20%;height:auto;margin-top:10px;margin-left:auto;margin-right:auto;
   }
		@media 
...
<div class="panel-body">
    ...
    <!-- Modal -->
      <div class="modal fade" id="my_deployment" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
...
<div class="panel-body">
    ...
    <!-- Modal -->
      <div class="modal fade" id="my_account" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog">
...
<!-- Ending Modal for re-assign->
    ...
    <!-- Modal -->
      <div class="modal fade" id="mypsipop" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
         <div class="modal-dialog">
