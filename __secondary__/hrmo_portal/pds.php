                        ...
                        <div class="panel-body">
                          <!-- Nav tabs -->
                            ...
                            <div class="tab-content">
								...
								<h4>I. Personal Information</h4>
                                  <?php
									echo '<table>
											...
											if ($row['Picture']=="")
											{
												echo '<img src="../images/user.png" width="200" height="250"   style="padding:4px;margin:4px;border-radius:10px;" id="pic" align="left">';
											}else{
												echo '<img src="'.$_SESSION['Picture'].'" width="200" height="250"   style="padding:4px;margin:4px;border-radius:10px;" id="pic" align="left">';
										...
										<tr><th style="text-align:left;">NAME: '.$_SESSION['Last_Name'].', '.$_SESSION['First_Name'].' '.$_SESSION['Middle_Name'].'</th></tr>
										...
										<tr><th  style="text-align:left;">Emp. ID: '.$_SESSION['EmpID'].'</th></tr>	
								...
								<form action="pds.php?link=<?php echo sha1("deped-pagadian management information system");?>" method="POST" enctype="multipart/form-data">
								...
								<input type="submit" name="Save" value="Save" style="cursor:pointer;" class="btn btn-primary">
								 ...
								 ?>
														...
														<!-- Modal for update information-->
														  <div class="modal fade" id="Birthdate" role="dialog" data-backdrop="static" data-keyboard="false">
															<div style="width:1000px;height:auto;margin-top:100px;margin-left:auto;margin-right:auto;">
															
															  <!-- Modal content-->
															  <div class="modal-content">
																<div class="modal-header">
																  <button type="button" class="close" data-dismiss="modal">&times;</button>
																  <h4 class="modal-title">Update Information
																</div>
																<div class="modal-body">
																<form enctype="multipart/form-data" method="post" role="form" action="pds.php?link=<?php echo sha1("deped-pagadian management information system");?>">
															<div class="form-group">
																			<?php
																			echo '<table>
																			
																			<tr><th width="15%" style="text-align:right;padding:4px;">SURNAME</th>
																			<th><input type="text" name="LName"  value="'.$_SESSION['Last_Name'].'" class="form-control" ></th>
																			<th style="text-align:right;padding:4px;">FIRST NAME</th>
																			<th><input type="text" name="FName"  value="'.$_SESSION['First_Name'].'" class="form-control" ></th>
																			<th style="text-align:right;padding:4px;">MIDDLE NAME</th>
																			<th><input type="text" name="MName" value="'.$_SESSION['Middle_Name'].'" class="form-control" ></th></tr>
																			<tr><th width="15%" style="text-align:right;padding:4px;" >DATE OF BIRTH<br/>(mm/dd/yyyy)</th>
																				<th>
																					<input type="text" name="Month" value="'.$_SESSION['Month'].'" size="2" style="text-align:center;padding:4px;margin:4px;" >
																					<input type="text" name="Day" value="'.$_SESSION['Day'].'" size="2" style="text-align:center;padding:4px;margin:4px;" >
																					<input type="text" name="Year" value="'.$_SESSION['Year'].'" size="2" style="text-align:center;padding:4px;margin:4px;" >
																					</th>
																				<th style="text-align:right;padding:4px;">CITIZENSHIP</th>
																			<th><input type="text" name="citizen"  value="'.$_SESSION['Citizen'].'" class="form-control"></th>
																			<th style="text-align:right;padding:4px;">CIVIL STATUS:</th>
																			<th><select name="CS" class="form-control" >
																				<option value="'.$_SESSION['Civil_Status'].'">'.$_SESSION['Civil_Status'].'</option>
																			...
																			<tr><th style="text-align:right;padding:4px;">PLACE OF BIRTH:</th>
																			<th><input type="text" name="PLB"  value="'.$_SESSION['Place_of_Birth'].'" class="form-control"></th>
																			<th style="text-align:right;padding:4px;">HEIGHT (m):</th>
																			<th style="padding:4px;"><input type="text" name="height"  value="'.$_SESSION['Height'].'" class="form-control"></th>
																			<th style="text-align:right;padding:4px;">SEX:</th>
																			<th style="padding:4px;"><select name="gender" class="form-control" >
																				<option value="'.$_SESSION['Gender'].'">'.$_SESSION['Gender'].'</option>
																				<option value="Male">Male</option>
																				<option value="Female">Female</option>
																				</select></th>
																			</tr>
																			<tr><th style="text-align:right;padding:4px;">RESIDENTIAL ADDRESS:</th>
																			<th colspan="1"><input type="text" name="address"  value="'.$_SESSION['Address'].'" class="form-control"></th>
																			<th style="text-align:right;padding:4px;">WEIGHT (kg):</th>
																			<th style="padding:4px;"><input type="text" name="weight"  value="'.$_SESSION['Weight'].'" class="form-control"></th>
																			<th style="text-align:right;padding:4px;">BLOOD TYPE:</th>
																			<th style="padding:4px;"><input type="text" name="blood"  value="'.$_SESSION['Blood'].'" class="form-control"></th>
																			</tr>
																			</table>
																	</div>
															<button type="submit" class="btn btn-primary" name="save_infor" value="SAVE">UPDATE</button>
														</form>
																</table>';
																?>
																</div>
                                ...
                                <div class="tab-pane fade" id="family-background">
									...
									<div style="overflow-x:auto;width:100%;">
										...
										<tbody>
										<?php
										$result1=mysqli_query($con,"SELECT * FROM family_background WHERE Emp_ID='".$_SESSION['EmpID']."' ORDER BY No Asc");
                                ...
                                <div class="tab-pane fade" id="education-background">
                                  ...
                                  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										<?php
										$result2=mysqli_query($con,"SELECT * FROM educational_background WHERE Emp_ID='".$_SESSION['EmpID']."' ORDER BY No Asc");
                                ...
                                <div class="tab-pane fade" id="eligibility-background">
                                  ...
                                  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										<?php
										$result3=mysqli_query($con,"SELECT * FROM civil_service WHERE Emp_ID='".$_SESSION['EmpID']."' ORDER BY No Asc");
								...
								<div class="tab-pane fade" id="voluntary-background">
								  ...
								  <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										<?php
										$result5=mysqli_query($con,"SELECT * FROM voluntary_work WHERE Emp_ID='".$_SESSION['EmpID']."' ORDER BY No Asc");
								...
								<div class="tab-pane fade" id="others-background">
								   ...
								   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
										...
										<tbody>
										<?php
										$result7=mysqli_query($con,"SELECT * FROM other_information WHERE other_information.Emp_ID='".$_SESSION['EmpID']."' ORDER BY other_information.No Asc");
								...
								<div class="tab-pane fade" id="reference-background">
                                    ...
                                    <h4>
                                     42. References (Person not related by consanguinity or afinity to applicant / appointee) </h4> 
										...
										<?php
										$no=0;
										$result8=mysqli_query($con,"SELECT * FROM reference WHERE Emp_ID='".$_SESSION['EmpID']."' ORDER BY No Asc");
