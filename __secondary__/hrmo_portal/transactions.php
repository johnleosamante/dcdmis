						  ...
						  <a href="#newtrack" class="btn btn-default" style="float:right;" data-toggle="modal" Title="Add New Transaction"><i class="fa fa-comments fa-fw"></i>New Transaction</a>
							...
							if (isset($_POST['new_transaction']))
							{
							   $dataA=$_POST['Qualname'];
								...
								mysqli_query($con,"INSERT INTO tbl_transactions VALUES ('".$_POST['Qualicode']."','".$dataA."','".$dateposted."','HRMO','".$_POST['status']."','Unread','123131','')");
							
								if (mysqli_affected_rows($con)==1)
								{
									mysqli_query($con,"INSERT INTO tbl_transactions_log VALUES (NULL,'".$dateposted."','".$_SESSION['uid']."','HRMO','".$_POST['first']."','".$_POST['status']."','".$_POST['Qualicode']."','New')");
