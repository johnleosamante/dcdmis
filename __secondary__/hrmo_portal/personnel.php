 ...
 ?>
                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
						 ...
						 <a href="#myPersonnel" class="btn btn-default" data-toggle="modal" style="float:right;"><i class="fa fa-user fa-fw"></i>New Personnel</a>
								...
								$no=0;
									...
									while($row=mysqli_fetch_array($myinfo))
									{
                                      ...
                                      echo '<tr class="gradeA">
											...
											<td>
											   <a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&c='.urlencode(base64_encode($row['Emp_ID'])).'&v='.urlencode(base64_encode("profile")).'" class="btn btn-info" style="padding:4px;margin:4px;" title="View Personal Data Sheet"><i class="fa fa-desktop fa-fw"></i></a>
											</td>
                                        </tr>';
     ...
     <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
		  ...
		  <h4 class="modal-title"><center>NEW EMPLOYEES</center></h4>
                ...
                <div class="panel panel-default">
                            ...
                            <dl class="dl-horizontal">
								...
								?>
								 ...
								 <table width="100%">
									<tr>
										 <dd><td width="35%"><label>CATEGORY:</label></td><td width="30%"><label>OFFICE:</label></td>
									</tr>
										<tr><td>
