  <div class="modal-header">
          ...
          <h3 class="modal-title"><center>Assignment History</center></h3>
...
$id=$_GET[$key]=base64_decode(urldecode($data));
	    ...
	    $_SESSION['per_id']=$id;
					...
					echo  '</b>  <a href="assign.php" data-toggle="modal" data-target="#reassign" class="btn btn-primary" ><i class="fa fa-male   fa-fw"></i> Assign</a><hr/>';
					echo '<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
									...
									<tbody>';
										...
										$no=0;
										$myinfo=mysqli_query($con,"SELECT * FROM tbl_deployment_history INNER JOIN tbl_school ON tbl_deployment_history.station_assign = tbl_school.SchoolID INNER JOIN tbl_job ON tbl_deployment_history.position_assign = tbl_job.Job_code WHERE tbl_deployment_history.Emp_ID='".$id."'")or die ("Deployment Information error");
