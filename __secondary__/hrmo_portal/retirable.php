									...
									while($row=mysqli_fetch_array($myinfo))
									{
                                      ...
                                      echo '<tr class="gradeA">
											...
											<td style="text-align:center;">
															...
															<a href="view_information.php?id='.$row['Emp_ID'].'" data-toggle="modal" data-target="#myinfo" title="view personnel records" class="btn btn-info"><i class="fa  fa-desktop fa-fw"></i></a>
