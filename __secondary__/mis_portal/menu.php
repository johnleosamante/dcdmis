		    ...
		    <div class="panel panel-default">
                 ...
                 echo '<label>'.$data['Emp_FName'].' '.$gdata.'. '.$data['Emp_LName'].'</label><br/>
				  <small>'.$data['Job_description'].' </small> 
					...
					<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("settings")).'"><i class="fa fa-gear fa-fw"></i>Settings</a> || <a href="../logout.php"><i class="fa fa-sign-out fa-fw"></i>Logout</a>	
