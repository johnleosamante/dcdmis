									...
									<tbody>
									  ...
									  $KinTotal=$KinEng+$KinScie+$KinMath+$KinFil+$KinAral+$KinESP+$KinTLE+$KinMAPEH+$KinMT+$KinPR;
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("Kinder")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
									  ...
									  $G1Total=$G1Eng+$G1Scie+$G1Math+$G1Fil+$G1Aral+$G1ESP+$G1TLE+$G1MAPEH+$G1MT+$G1PR;
										...
										echo '<tr>	
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("1")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
										
											</tr>';
									  $G2Eng=$G2Scie=$G2Math=$G2Fil=$G2Aral=$G2ESP=$G2TLE=$G2MAPEH=$G2MT=$G2Total=$G2RO=$G2PR=0;
									  $myG2=mysqli_query($con,"SELECT * FROM tbl_elementary_subject WHERE GradeLevel='2' AND WeekNo='".$_SESSION['week']."' AND QuarterNo='".$_SESSION['quarter']."' AND School_Year='".$_SESSION['year']."'");
									  ...
									  $G2Total=$G2Eng+$G2Scie+$G2Math+$G2Fil+$G2Aral+$G2ESP+$G2TLE+$G2MAPEH+$G2MT+$G2PR;
										...
										echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("2")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("3")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											<tr>	
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("4")).'&v='.urlencode(base64_encode("view_school")).'" title="View School"> <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("5")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
											...
											echo '<tr>
													...
													<td style="text-align:center;"><a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode("6")).'&v='.urlencode(base64_encode("view_school")).'" title="View School" > <i class="fa   fa-desktop  fa"></i></td>
