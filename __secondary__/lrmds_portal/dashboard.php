				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-primary">
                       ...
                       <?php
						echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("readiness")).'">';
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                       ...
                       <?php
						echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("textbook")).'">';
				...
				<div class="col-lg-3 col-md-6">
                    <div class="panel panel-green">
                        ...
                        <?php
						echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("post")).'">';
