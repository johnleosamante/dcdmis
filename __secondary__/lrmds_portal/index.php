		...
		<div id="page-wrapper">
			...
			<div class="row" style="margin-top: 20px;">
				...
				if (!isset($url)) {
					...
					} elseif ($url == 'list_of_modules') {
						include("list_of_modules.php");
					...
					} elseif ($url == 'view_subject') {
						include("list-of-school.php");
					} elseif ($url == 'view_record') {
						$_SESSION['SchoolID'] = $_GET['c'];
						echo '<iframe src="view_record.php" style="width:100%;height:800px;border:none;"></iframe>';
					} elseif ($url == 'settings') {
						include("setting.php");
