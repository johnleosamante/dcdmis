        ...
        uploader.init();
			...
			<div class="col-lg-12">
						          <div class="panel panel-default">
									...
									<?php echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("list_of_activity")).'" style="float:right;" class="btn btn-secondary">Back</a>';?>
									<a href="#newtemplate" class="btn btn-primary" style="float:right;" data-toggle="modal">Upload Certificate</a>
									...
									while($viewrow=mysqli_fetch_array($viewparticipants))
									{
										...
										echo '<tr>
												...
												<td><a href="print_certificate.php?certificate='.urlencode(base64_encode($viewrow['Emp_ID'])).'" target="_blank">PREVIEW</a> <br/> 
