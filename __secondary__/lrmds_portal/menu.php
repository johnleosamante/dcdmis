<ul class="nav" id="side-menu">
	...
	$_SESSION['prepared']=$data['Emp_FName'].' '.$gdata.'. '.$data['Emp_LName'];
		...
		if ($_SESSION['ucode']=='Administrator')
		{
             echo '<li>
				...
				<li>
                   ...
                   <li>
				   <a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&v='.urlencode(base64_encode("list_of_modules")).'"><i class="fa fa-book fa-fw"></i> List of Modules</a>
				</li>
