	...
	<tbody>
		...
		while($row=mysqli_fetch_array($result))
		{
		    ...
		    <td style="text-align:center;">'.number_format($totModule,2).'</td>
		     <td style="text-align:center;"> <a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&GL='.urlencode(base64_encode($row['Grade'])).'&Code='.urlencode(base64_encode($row['SpCode'])).'&v='.urlencode(base64_encode("view_school")).'"><i class="fa   fa-desktop  fa"></i></a></td>													
		</tr>';
		}
