                 ...
                 <div class="col-lg-12">
                    <div class="panel panel-default">
                         <div class="panel-heading">
						 	 <?php
						 echo '<a href="./?'.$str.'7e9ff1f60111f1bf6a3696b2092ac4a7285cd942&code='.urlencode(base64_encode($_SESSION['TrainingCode'])).'&v='.urlencode(base64_encode("view_list")).'" style="float:right;" class="btn btn-secondary">Back</a>';
