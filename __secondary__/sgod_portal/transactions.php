                         ...
                         <div class="panel-heading">
						  <a href="#newtrack" class="btn btn-primary" style="float:right;" data-toggle="modal">New Transaction</a>
							...
							if (isset($_POST['new_transaction']))
							{
								...
								mysqli_query($con,"INSERT INTO tbl_transactions VALUES ('".$_POST['Qualicode']."','".$dataA	."','".$dateposted."','SGOD','".$_POST['status']."','Unread','123131','')");
								if (mysqli_affected_rows($con)==1)
								{
									mysqli_query($con,"INSERT INTO tbl_transactions_log VALUES (NULL,'".$dateposted."','".$_SESSION['uid']."','SGOD','".$_POST['first']."','".$_POST['status']."','".$_POST['Qualicode']."','New')");
