...
session_start();
   include("../vendor/jquery/function.php");
	$posted=mysqli_query($con,"SELECT * FROM reply INNER JOIN tbl_employee ON reply.posted_by=tbl_employee.Emp_ID WHERE reply.chat_id ='".$_SESSION['chat-id']."' ORDER BY reply.date_posted Desc");
