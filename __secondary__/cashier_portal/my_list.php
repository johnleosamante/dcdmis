...
$url=$_GET[$key]=base64_decode(urldecode($data));
	    ...
	    echo '<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                             <thead>
                                ...
                                <tbody>';
								$no=0;
								$result=mysqli_query($con,"SELECT * FROM tbl_school_participant INNER JOIN tbl_school ON tbl_school_participant.SchoolID=tbl_school.SchoolID WHERE tbl_school_participant.Training_Code='".$url."'")or die("Error School Paticipants");
