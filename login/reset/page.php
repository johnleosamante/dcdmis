...
<div class="col-xl-5 col-lg-5 col-md-8 col-sm-12">
    <div class="card o-hidden border-0 shadow-lg my-5">
        ...
        <div class="card-body text-center">
            ...
            <form action="" method="POST">
                <div class="form-group">
                    <input class="form-control" id="email" name="email" type="email" placeholder="juan.delacruz@deped.gov.ph" value="<?php echo $userEmail; ?>" autofocus required>
                </div>
        ...
        <div class="card-footer text-center">
            <a class="small" href="<?php echo uri() . '/login'; ?>" title="Login to your account">Login to your account instead</a>
        </div>
    </div>
</div>