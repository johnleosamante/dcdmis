        ...
        <div class="card-body text-center">
            ...
            <form action="" method="POST" class="text-left mt-3">
                ...
                <div class="form-group">
                    ...
                    <input id="email-address" type="text" class="form-control border" value="<?= e($email) ?>" readonly>
                </div>
                ...
                <div class="form-group">
                    <label for="password-confirm" class="font-weight-bold mb-1">Confirm New Password
                        <?php showAsterisk() ?></label>
                    <div id="password-confirm-group" class="input-group border rounded">
                        <input id="password-confirm" name="password-confirm" type="password"
                            class="form-control border-0" value="<?= e($passwordConfirm) ?>" required>
                        <div class="input-group-append">
                ...
                <button id="change-password" type="submit" class="btn btn-primary btn-block"
