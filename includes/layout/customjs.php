...
if (isset($_GET['v'])) {
    ...
    if ($v === 'Courses') {
        ...
        echo ' <script src="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js"></script>';
        echo '<script src="' . uri() . '/modules/lnd-activity/activity.js?v=1.4" type="text/javascript"></script>';
        echo '<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script>';
    } elseif ($v === 'Project Detail') {
        echo '<script src="' . uri() . '/modules/lnd-activity/activity.js?v=1.4" type="text/javascript"></script>';
    } elseif ($v === 'Attendance') {
        echo '<script src="https://code.jquery.com/ui/1.13.2/jquery-ui.min.js"></script>';
        echo '<script src="' . uri() . '/modules/trainings/modules/activity.js?v=1.4" type="text/javascript"></script>';
