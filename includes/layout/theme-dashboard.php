            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content shadow-lg border-0">
                    ...
                    <div class="modal-body p-4 text-dark" style="max-height: 500px; overflow-y: auto;">
                        ...
                        <p class="small">This system is an official platform of the Schools Division Office of Dipolog City
                            and is accessible only to authorized DepEd personnel using enterprise-issued accounts.</p>
                        <p class="small">By accessing and using this platform, you acknowledge and agree to the following:
                        </p>
                        <hr class="my-3">
                        <h6 class="font-weight-bold mb-1">1. Compliance with Data Privacy Laws</h6>
                        <p class="small text-secondary mb-3">You shall comply with the provisions of Republic Act No. 10173
                            (Data Privacy Act of 2012), its Implementing Rules and Regulations, and applicable issuances of
                        ...
                        <p class="small text-secondary mb-3">You are accountable for all activities performed under your
                            login credentials. Any access, processing, or use of personal data shall be done in accordance
                        ...
                        <p class="small text-secondary mb-0">Any violation of data privacy policies and applicable laws may
                    ...
                    <div class="modal-footer bg-light d-flex flex-column align-items-stretch p-3">
                        <form action="" method="POST" id="dataPrivacyForm" class="w-100">
                            ...
                            <div class="custom-control custom-checkbox mb-3 text-left">
                                ...
                                <label class="py-1 custom-control-label small font-weight-bold text-dark cursor-pointer"
                                    for="agreeCheckbox">
