...
function update_employee($lname, $fname, $mname, $ext, $bmonth, $bday, $byear, $pob, $sex, $civil_status, $civil_status_specify, $citizenship, $dual_citizenship, $country, $rlot, $rstreet, $rsubdivision, $rbarangay, $rcity, $rprovince, $rzip, $plot, $pstreet, $psubdivision, $pbarangay, $pcity, $pprovince, $pzip, $height, $weight, $blood_type, $gsis, $pagibig, $philhealth, $sss, $telephone, $mobile, $email, $tin, $agency_id, $photo, $id) {
  non_query("UPDATE tbl_employee SET Emp_LName='{$lname}', Emp_FName='{$fname}', Emp_MName='{$mname}', Emp_Extension='{$ext}', Emp_Month='{$bmonth}', Emp_Day='{$bday}', Emp_Year='{$byear}', Emp_place_of_birth='{$pob}', Emp_Sex='{$sex}', Emp_CS='{$civil_status}', Emp_CS_Others='{$civil_status_specify}', Emp_Citizen='{$citizenship}', Emp_Dual_Citizenship='{$dual_citizenship}', Emp_Country='{$country}', Emp_Res_Lot='{$rlot}', Emp_Res_Street='{$rstreet}', Emp_Res_Subdivision='{$rsubdivision}', Emp_Res_Barangay='{$rbarangay}', Emp_Res_City='{$rcity}', Emp_Address='{$rprovince}', Emp_Res_ZIP='{$rzip}', Emp_Per_Lot='{$plot}', Emp_Per_Street='{$pstreet}', Emp_Per_Subdivision='{$psubdivision}', Emp_Per_Barangay='{$pbarangay}', Emp_Per_City='{$pcity}', Emp_Per_Province='{$pprovince}', Emp_Per_ZIP='{$pzip}', Emp_Height='{$height}', Emp_Weight='{$weight}', Emp_Blood_type='{$blood_type}', Emp_GSIS='{$gsis}', Emp_PAGIBIG='{$pagibig}', Emp_PHILHEALTH='{$philhealth}', Emp_SSS='{$sss}', Emp_Telephone='{$telephone}', Emp_Cell_No='{$mobile}', Emp_Email='{$email}', Emp_TIN='{$tin}', EmpNo='{$agency_id}', Picture='{$photo}' WHERE Emp_ID='{$id}' LIMIT 1;");
}
?>