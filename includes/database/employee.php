...
function createEmployee($id, $lname, $fname, $mname, $ext, $sex, $bmonth, $bday, $byear, $email, $mobile, $image, $status, $crn = '', $bp = '', $pagibig = '', $philhealth = '', $tin = '', $agencyId = '')
{
    nonQuery("INSERT INTO tbl_employee (Emp_ID, Emp_LName, Emp_FName, Emp_MName, Emp_Extension, Emp_Sex, Emp_Month, Emp_Day, Emp_Year, Emp_Email, Emp_Cell_No, Picture, Emp_Status, Emp_GSIS, Emp_GSIS_BP, Emp_PAGIBIG, Emp_PHILHEALTH, Emp_TIN, EmpNo) VALUES ('{$id}', '{$lname}', '{$fname}', '{$mname}', '{$ext}', '{$sex}', '{$bmonth}', '{$bday}', '{$byear}', '{$email}', '{$mobile}', '{$image}', '{$status}', '{$crn}', '{$bp}', '{$pagibig}', '{$philhealth}', '{$tin}', '{$agencyId}');");
}
