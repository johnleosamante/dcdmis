...
<div class="text-center py-0">
    ...
    <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-8 col-md-10 col-sm-12">
            <p class="text-gray-600 px-2 mb-4">Track paper trail of documents submitted to the Schools Division Office
                created by schools, sections and offices within the schools division.</p>
        </div>
    </div>
