...
<div class="row mt-4">
  ...
  card('Outgoing Documents', custom_uri('dts', 'Outgoing Documents'), 'fa-file-upload', $is_school_portal ? 'primary' : 'info', num_rows(outgoing_documents($station)));

  card('Ongoing Documents', custom_uri('dts', 'Ongoing Documents'), 'fa-tasks', $is_school_portal ? 'success' : 'warning', num_rows(ongoing_documents($station)));

  card('Completed Documents', custom_uri('dts', 'Completed Documents'), 'fa-check-circle', $is_school_portal ? 'info' :'secondary');
