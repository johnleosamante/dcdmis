        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <div class="form-group">
                    ...
                    <input type="text" id="telephone" class="form-control" value="<?php echo $telephone; ?>" readonly>
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <div class="form-group">
                    ...
                    <input type="text" id="alternate-mobile" name="alternate-mobile" class="form-control" value="<?php echo $alternateMobile; ?>" required>
                </div>
            </div>
        </div>
