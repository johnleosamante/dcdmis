...
$contact = employeeContactDetails($userId);

if ($contact) {
    $primaryEmail = $contact['email_address'];
    $alternateEmail = $contact['alternate_email_address'];
    $telephone = $contact['telephone'];
    $mobileNo = $contact['mobile_number'];
    $alternateMobile = $contact['alternate_mobile_number'];
}
?>
<div class="tab-pane fade" id="contact-details">
    <form class="py-2" action="" method="POST">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <input name="update-contact-details" type="submit" value="Update Contact Details"
