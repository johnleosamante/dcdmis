...
<div class="tab-pane fade" id="password-change">
            ...
            <div class="my-2 px-3 py-2 rounded alert-info text-left d-flex">
                ...
                <span class="ml-2 d-inline-block d-flex align-items-center small">
                    <div>To help secure your account, please use atleast one (1) uppercase, atleast one (1) lowercase,
                        ...
                        password you can use instead.</div>
                </span>
            </div>
        </div>
    </div>
    ...
    <form class="py-2" action="" method="POST">
            ...
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="old-password" name="old-password" type="password" class="form-control border-right-0"
                            value="<?= e($oldPassword) ?>" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="password-confirm" name="password-confirm" type="password"
                            class="form-control border-right-0" value="<?= e($passwordConfirm) ?>" required>
                        <div class="input-group-append">
                            <button type="button" id="eye-confirm-toggle"
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input id="generate-password" name="generate-password" type="text" class="form-control"
                            value="<?= e($generatePassword) ?>">
                        <div class="input-group-append">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <input name="update-password" type="submit" value="Update Password"
