<?php
// modules/transfer-request/approve-dialog.php
...
$employee = $positionTitle = $picture = null;

if ($request) {
    $hasRequest = true;
    $modalTitle = 'Approve Transfer Request';
        ...
        <form action="" method="POST">
            ...
            <div class="modal-body">
                <?php if ($hasRequest) {
                    ...
                    message("Approving this request will automatically update the employee's active station assignment to the preferred station assignment.", 'info', 'info-circle', 2, 3);
                    ?>
                    ...
                    <div class="form-group mb-0">
                        <label for="remarks" class="mb-0 font-weight-bold small">Remarks</label>
                        <textarea id="remarks" name="remarks" class="form-control" rows="3"
            ...
            <div class="modal-footer">
                <?php if ($hasRequest): ?>
                    ...
                    <button class="btn btn-primary" name="approve-transfer-request" type="submit">
                        Continue</button>
                <?php endif;
                cancelModalButton() ?>
            </div>
