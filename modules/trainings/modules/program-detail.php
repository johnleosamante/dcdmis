...
$programId = isset($_GET['id']) ? decode($_GET['id']) : null;
    ...
    <nav class="d-flex align-items-center flex-row m-0">
        <ol class="breadcrumb m-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item">
                <a href="<?= customUri('hrtdms', 'Program') ?>">Program Detail /</a>
            </li>
        </ol>
    </nav>
</div>
...
<div class="card border-left-success shadow mb-4">
    <div class="card-header py-3 d-flex justify-content-between align-items-center">
        <h3 class="mb-0">Program Detail</h3>
        ...
        <div class="table-responsive mb-3">
            <table cellspacing="0">
                <tr>
                    ...
                    <td class="text-uppercase"><?= ($program['program_code']) ?></td>
                </tr>
                <tr>
                    <th class="align-top pr-5" scope="row">Title</th>
                    <td class="text-uppercase"><?= ($program['program_name']) ?></td>
                </tr>
                <tr>
                    <th class="align-top pr-5" scope="row">Description</th>
                    <td class="text-uppercase"><?= ($program['description']) ?></td>
                </tr>
                <tr>
                    <th class="align-top pr-5" scope="row">Date Created</th>
                    <td class="text-uppercase"><?= date('M d, Y', strtotime($program['created_at'])) ?></td>
                </tr>
...
<h4><i class="fa fa-list"></i> Project List</h4>
<div class="row">
    <?php if (!empty($projects)): ?>
        <?php foreach ($projects as $project): ?>
            <div class="col-md-4 mb-3">
                <div class="card border-left-success shadow h-100 program-card">
                    ...
                    <div class="card-body position-relative">
                        ...
                        <div class="d-flex justify-content-between align-items-start">
                            ...
                            <div class="d-flex align-items-start">
                                ...
                                <div class="mr-3">
                                    <i class="fa fa-folder-open fa-2x text-success"></i>
                                </div>

                                <div class="w-100">

                                    <h4 class="font-weight-bold mb-1">
                                        <a href="http://<?= $_SERVER['HTTP_HOST'] ?>/hrtdms/?v=<?= base64_encode('Project Detail') ?>&id=<?= base64_encode($project['project_id']) ?>"
                                    ...
                                    <p class="mb-2 text-muted">
                                        <?= e($project['description'] ?? 'No description') ?>
                                    </p>
                                ...
                                <div class="dropdown-menu dropdown-menu-right shadow">
                                    ...
                                    <button class="dropdown-item"
                                            ...
                                            <?= (int) $project['project_id'] ?>,
                                                                    '<?= htmlspecialchars($project['project_code'], ENT_QUOTES) ?>',
                                                                    ...
                                                                    '<?= htmlspecialchars($project['end_date'], ENT_QUOTES) ?>'
                                                                    )">
