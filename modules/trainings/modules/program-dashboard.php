    ...
    <nav class="d-flex align-items-center flex-row m-0">
        <ol class="breadcrumb m-0 p-0 bg-transparent">
            ...
            <li class="breadcrumb-item">
                <a href="<?= customUri('hrtdms', 'Program') ?>">Program List /</a>
            </li>
        </ol>
    </nav>
</div>
...
<div class="d-sm-flex align-items-center flex-row-reverse mb-3">
    <button type="button"
            ...
            data-toggle="modal"
            onclick="resetProgramInput()"
            data-target="#addProgramModal">
        <i class="fa fa-plus"></i> Add Program
    </button>
</div>

<h4><i class="fa fa-list"></i> Program List</h4>
<div class="row">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="program_code" name="program_code" class="form-control" placeholder="Program Code">
                    </div>

                    <div class="form-group">
                        <label>Program Name</label>
                        <input type="text" id="program_name" name="program_name" class="form-control" required placeholder="Program Name">
                    </div>
