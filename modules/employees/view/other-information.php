...
<div class="tab-pane fade<?php echo setActiveNavigation(isset($activeTab) && $activeTab === 'other-information', 'show active'); ?>" id="other-information">
  <?php if ($editMode) : ?>
    ...
    <div class="mt-3">
      ...
      <ol type="a" class="mb-0 pl-3">
        <li>within the third degree?
          <div class="py-1">
            <input id="has-third-degree-yes" name="has-third-degree" type="radio" value="1" <?php echo setActiveItem($hasThirdDegree, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="has-third-degree-yes" class="px-1 mr-3">Yes</label>

            <input id="has-third-degree-no" name="has-third-degree" type="radio" value="0" <?php echo setActiveItem($hasThirdDegree, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        ...
        <li>within the fourth degree (for Local Government Unit - Career Employees)?
          <div class="py-1">
            <input id="has-fourth-degree-yes" name="has-fourth-degree" type="radio" value="1" <?php echo setActiveItem($hasFourthDegree, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="has-fourth-degree-yes" class="px-1 mr-3">Yes</label>

            <input id="has-fourth-degree-no" name="has-fourth-degree" type="radio" value="0" <?php echo setActiveItem($hasFourthDegree, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div>
      <ol type="a" class="pl-3 mb-0">
        <li>Have you ever been found guilty of any administrative offense?
          <div class="py-1">
            <input id="was-guilty-yes" name="was-guilty" type="radio" value="1" <?php echo setActiveItem($wasGuilty, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="was-guilty-yes" class="px-1 mr-3">Yes</label>

            <input id="was-guilty-no" name="was-guilty" type="radio" value="0" <?php echo setActiveItem($wasGuilty, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        ...
        <li>Have you been criminally charged before any court?
          <div class="py-1">
            <input id="was-charged-yes" name="was-charged" type="radio" value="1" <?php echo setActiveItem($wasCharged, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="was-charged-yes" class="px-1 mr-3">Yes</label>

            <input id="was-charged-no" name="was-charged" type="radio" value="0" <?php echo setActiveItem($wasCharged, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div>
      ...
      <div class="pl-3">
        <input id="was-convicted-yes" name="was-convicted" type="radio" value="1" <?php echo setActiveItem($wasConvicted, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        <label for="was-convicted-yes" class="px-1 mr-3">Yes</label>

        <input id="was-convicted-no" name="was-convicted" type="radio" value="0" <?php echo setActiveItem($wasConvicted, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div>
      ...
      <div class="pl-3">
        <input id="was-separated-yes" name="was-separated" type="radio" value="1" <?php echo setActiveItem($wasSeparated, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        <label for="was-separated-yes" class="px-1 mr-3">Yes</label>

        <input id="was-separated-no" name="was-separated" type="radio" value="0" <?php echo setActiveItem($wasSeparated, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div>
      <ol type="a" class="pl-3 mb-0">
        <li>Have you ever been a candidate in a national or local election (except Barangay election)?
          <div class="my-1">
            <input id="was-candidate-yes" name="was-candidate" type="radio" value="1" <?php echo setActiveItem($wasCandidate, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="was-candidate-yes" class="px-1 mr-3">Yes</label>

            <input id="was-candidate-no" name="was-candidate" type="radio" value="0" <?php echo setActiveItem($wasCandidate, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        ...
        <li>Have you resigned from the government service during the three (3)-month period the last election to promote/actively campaign for a national or local candidate?
          <div class="my-1">
            <input id="resigned-yes" name="resigned" type="radio" value="1" <?php echo setActiveItem($resigned, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="resigned-yes" class="px-1 mr-3">Yes</label>

            <input id="resigned-no" name="resigned" type="radio" value="0" <?php echo setActiveItem($resigned, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div>
      ...
      <div class="pl-3">
        <input id="immigrant-yes" name="immigrant" type="radio" value="1" <?php echo setActiveItem($immigrant, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        <label for="immigrant-yes" class="px-1 mr-3">Yes</label>

        <input id="immigrant-no" name="immigrant" type="radio" value="0" <?php echo setActiveItem($immigrant, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
    ...
    <div class="mb-3">
      ...
      <ol type="a" class="mb-0 pl-3">
        <li>Are you a member of any indigenous group?
          <div class="my-1">
            <input id="is-indigenous-yes" name="is-indigenous" type="radio" value="1" <?php echo setActiveItem($isIndigenous, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="is-indigenous-yes" class="px-1 mr-3">Yes</label>

            <input id="is-indigenous-no" name="is-indigenous" type="radio" value="0" <?php echo setActiveItem($isIndigenous, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
        ...
        <li>Are you differently abled?
          <div class="my-1">
            <input id="is-differently-abled-yes" name="is-differently-abled" type="radio" value="1" <?php echo setActiveItem($isDifferentlyAbled, '1', 'checked');  echo !$editMode ? ' disabled' : ''; ?>>
            <label for="is-differently-abled-yes" class="px-1 mr-3">Yes</label>

            <input id="is-differently-abled-no" name="is-differently-abled" type="radio" value="0" <?php echo setActiveItem($isDifferentlyAbled, '0', 'checked');  echo !$editMode ? ' disabled' : ''; ?>>
        ...
        <li>Are you a solo parent?
          <div class="my-1">
            <input id="is-solo-parent-yes" name="is-solo-parent" type="radio" value="1" <?php echo setActiveItem($isSoloParent, '1', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
            <label for="is-solo-parent-yes" class="px-1 mr-3">Yes</label>

            <input id="is-solo-parent-no" name="is-solo-parent" type="radio" value="0" <?php echo setActiveItem($isSoloParent, '0', 'checked'); echo !$editMode ? ' disabled' : ''; ?>>
