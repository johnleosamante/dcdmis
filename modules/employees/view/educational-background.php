...
<div class="tab-pane fade<?php echo set_active_navigation(isset($_SESSION['pdstab']) && $_SESSION['pdstab'] === 'educational-background', 'show active'); ?>" id="educational-background">
  <div class="row my-3">
