...
<div class="tab-pane fade<?php echo set_active_navigation(isset($_SESSION['pdstab']) && $_SESSION['pdstab'] === 'civil-service-eligibility', 'show active'); ?>" id="civil-service-eligibility">
  <div class="row my-3">
