...
$family = family($employeeId);

if ($family) {
    $slast = $family['spouse_last_name'];
    $sfirst = $family['spouse_first_name'];
    $sext = $family['spouse_name_extension'];
    $smiddle = $family['spouse_middle_name'];
    $swork = $family['spouse_occupation'];
    $soffice = $family['spouse_employer'];
    $sofficeAddress = $family['spouse_employer_address'];
    $stelephone = $family['spouse_telephone'];
    $flast = $family['father_last_name'];
    $ffirst = $family['father_first_name'];
    $fext = $family['father_name_extension'];
    $fmiddle = $family['father_middle_name'];
    $mlast = $family['mother_last_name'];
    $mfirst = $family['mother_first_name'];
    $mmiddle = $family['mother_middle_name'];
}
?>

<div class="tab-pane fade<?= setActiveNavigation(isset($activeTab) && $activeTab === 'family-background', 'show active') ?>"
    ...
    <?php if ($editMode): ?>
        ...
        <?php if ($editMode): ?>
            <div class="form-group mb-3">
                ...
                <button class="btn btn-primary btn-block " name="update-family-background"><i
                        class="fas fa-save fa-fw"></i>Update Family Background</button>
            </div>
        </form>
    <?php endif ?>
</div>