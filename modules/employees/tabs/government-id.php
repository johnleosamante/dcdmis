...
$identification = employeeIdentification($employeeId);

if ($identification) {
    $cardType = $identification['card_type_id'];
    $cardTypes = cardType($cardType);
    $card = $cardTypes ? $cardTypes['name'] : 'N/A';
    $number = $identification['id_number'];
    $place = $identification['place_issued'];
    $date = toDate($identification['date_issued'], 'Y-m-d');
}
?>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-10 col-lg-6 col-xl-4 col">
                <div class="form-group">
                    <label for="card-type" class="mb-0">Government Issued ID <?php if ($isPis)
                        showAsterisk() ?></label>
                    <?php if ($isPis): ?>
                ...
                <?php if ($isPis): ?>
                    ...
                    <input name="update-identification" type="submit" value="Update Government Issued ID"
