<?php
// modules/race/notice-dialog.php
...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
            ...
            <div class="modal-footer">
                <?php if ($awardId): ?>
                    <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#modal"
                       onclick="loadData('<?= e(uri() . '/modules/race/criteria-dialog.php?id=' . cipher($awardId) . '&mode=edit-ranking') ?>'); return false;">
                        <i class="fas fa-clipboard-list fa-fw mr-1"></i> Set Criteria Now
                    </a>
                <?php endif; ?>
                <?php cancelModalButton() ?>
            </div>
        <?php elseif ($type === 'no-rankings'): ?>
        ...
        <?php else: ?>
            <?php modalHeader('Notice'); ?>
            <div class="modal-body"><p>Invalid notice type.</p></div>
