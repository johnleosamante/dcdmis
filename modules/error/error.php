...
$isAccessible = !isWeekend() && isOfficialTime();
...
<div class="text-center py-0">
    ...
    <p class="text-gray-500 mb-4">
        <?= $isAccessible ? 'It seems you have encountered a glitch in the system...' : 'It seems that the system is currently not accessible...' ?>
    </p>
